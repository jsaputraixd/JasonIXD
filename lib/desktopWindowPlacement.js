...
/** Status bar band (single desktop footer row). */
export const STATUS_BAR_RESERVE = 48;
...
export const PROJECT_GRID_LIFT = PROJECT_DOCK_H + 12;
...
export function getDeterministicDesktopPositions({
  ...
  const folderRowTop = Math.round(
    vh - STATUS_BAR_RESERVE - DESKTOP_FOLDER_ICON_H - Math.round(16 * layoutScale)
  );
