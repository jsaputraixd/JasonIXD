...
export const trashMessages = [
  ...
  "Error 404: deleted drafts not found.",
  ...
  "Trash.exe has stopped working. Just kidding.",
  "Composting old wireframes into new ones.",
  "Please do not feed the designers after midnight.",
  "Zero bytes. Infinite potential.",
  "Your rejected Figma frames live here now. Kidding. Maybe.",
